        ...
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
            ...
            <div class="panel panel-info resgister_panel_sytle">
                ...
                <div class="panel-body">
                    ...
                    本平台有如下的特色：<br/>
                    1、會員對商品的採購與否，基於自身的需求具有絕對的自主性，無入會費、無配額、無預付款、無邀約下線的壓力，無庸擔心加入網站給您帶來任何不便。 <br/>
                    2、因係利用團購力量爭取優惠價格的日用商品 ( 例如，無不良添加物的純蜂蜜，您在市場上通常是難以判定產品真偽且價格居高不下 ) ，簽約的商品價格低於一般市價，依合約只對網群內之會員販售，因此，這是個封閉性的網站，新入會人員須有舊會員推薦，且經本網站審核確認後始完成註冊，成為正式會員。 <br/>
                    3、所有推薦商品，一定盡力做到符合環保、安全、健康 ( 無不良添加 ) 等條件。 <br/>
                    4、註冊成為正式會員者均可獲贈100元紅利點數，爾後於網站內購物消費亦享有紅利回饋金積點(每消費滿100元回饋1點﹝1元﹞)，紅利點數不得要求折換現金或移轉至他人使用，在完成交易後，如果後續有付款失敗、訂單取消、退貨交易等情況的訂單恕無法符合紅利點數回饋資格。另如群組團購量超過商品簽約數量，廠商如果願意降低成本價所產生之額外利潤，亦將依會員購物金額比例回饋會員。 <br/>
                    5、凡會員參加團體預購活動，登記前請務必確定購買需求，為了保障參加登記預購會員的權利，您一旦登記後又取消者，累計三次，本網站即會自動取消您的會員資格。 <br/>
                    熱忱歡迎您因為認同我們的理念而加入會員，讓我們發揮螞蟻雄兵的力量找到安心的優質商品一同維護食品安全並守護家人健康，共享美好生活。<br/>
